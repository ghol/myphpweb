...
<script language="JavaScript" type="text/javascript" src="//cdn.bootcss.com/jquery/1.7.2/jquery.min.js"></script>
...
<div id="page">
    <div id="header">
        <h1><a href="_ooxx.php"><?php echo $title;?></a></h1>
...
<table width="100%" cellpadding="3" cellspacing="0" align="center">
  ...
  <?php echo (isset($_GET['speed']))?"下载1000KB数据用时 <font color='#cc0000'>".$_GET['speed']."</font> 毫秒，下载速度："."<font color='#cc0000'>".$speed."</font>"." kb/s，需测试多次取平均值，超过10M直接看下载速度":"<img src='adchina.png' border='0' width='500px' /><br /><font color='#cc0000'>&nbsp;未探测&nbsp;</font>" ?>
